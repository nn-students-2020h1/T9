...
class TestCovid(unittest.TestCase):
    ...
    def test_country_top_not_empty(self):
        with patch('modules.covid.requests.get') as mock_get:
            mock_get.return_value.json.return_value = [{"provincestate": "", "countryregion": "Co1", "lastupdate": "1", "confirmed": 100000, }, {
    ...
    def test_dynamic_top_not_empty(self):
        with patch('modules.covid.requests.get') as mock_get:
            mock_get.return_value.json.return_value = [{"provincestate": "", "countryregion": "Co1", "timeseries": {
